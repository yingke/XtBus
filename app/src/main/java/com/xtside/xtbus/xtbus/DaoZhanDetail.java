...
public class DaoZhanDetail extends AppCompatActivity {
    ...
    private  final  static  int TIMEMSG=1;
    ...
    public void showdialog_my() {
        ...
        ProgressWheel wheel = new ProgressWheel(DaoZhanDetail.this);
    ...
    public void starttimer(final String url){
        ...
        if (mTimerTask==null){
            ...
            mTimer.schedule(TimerTask_time,0,1000);
        }
